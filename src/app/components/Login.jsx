    ...
    <div className="min-h-screen flex items-center justify-center">
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          ...
          <h2 className="text-2xl font-bold mb-4">Login</h2>
            ...
            <img src='/img/card-trolly-image.jpg' alt='Trolley Image' className=' mt-5 mb-5  sm:mt-10 lg:mt-20 object-contain  relative bottom-0 rounded-full h-40'/>
          </div>
          <div className=''>
          <span
            ...
            <p className='font-roboto text-blue-600 text-center'>New to E-Shop?<Link href={"/signup"}> Create an account</Link></p>
            </div>
          </div>
        </div>
